...
<div class="app-card app-card-accordion shadow-sm mb-4">
    <div class="app-card-header p-4 pb-2  border-0">
       <a type="button" href="/mobil/create/" class="btn app-btn-primary mt-3">
        Tambah Driver
        </a>
    </div><!--//app-card-header-->
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a class="btn btn-info" href="/mobil/{{ $data['user_id'] }}">
                                    <i class="fa fa-eye"></i>
                                  </a>
                                <a class="btn btn-success" href="/mobil/edit/{{ $data['user_id'] }}">
                                  <i class="fa fa-pencil"></i>
                                </a>
                                <form action="{{ route('mobil.destroy', $data['user_id']) }}" method="post">
                                  @csrf
